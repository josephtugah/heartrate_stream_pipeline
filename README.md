...
The script has been containerized inside a Docker image using a `Dockerfile` located in the root folder of the project, which is then pushed into a Compute Engine instance and ran using a continuously.
