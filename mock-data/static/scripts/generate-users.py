...
def main():
    ...
    directory_path_users = "C:/Users/JosephTeyeTugah/Desktop/dataEngineering/gcp-streaming-project/mock-data/static/data"

    # Use os.path.join() to construct the file path for activities.csv
    csv_file_path = os.path.join(directory_path_users, "users.csv")
